...
export const SVG : string = `<svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="80px"  viewBox="0 0 1280.000000 640.000000" preserveAspectRatio="xMidYMid meet">
